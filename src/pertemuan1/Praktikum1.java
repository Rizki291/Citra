...
public class Praktikum1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ambil == JFileChooser.APPROVE_OPTION){
            ...
            jLabel3.setIcon(new ImageIcon(sumber));
        }
        IconGambar = new ImageIcon(sumber).getImage();
        int ukrX = IconGambar.getWidth(null);
        int ukrY = IconGambar.getWidth(null);
        jTextField1.setText(Integer.toString(ukrX));
        jTextField2.setText(Integer.toString(ukrY));
